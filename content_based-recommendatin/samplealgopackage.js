...
class ContentBasedRecommender { //defining class
  constructor(options = {}) {  //defining constructor
  ...
  setOptions(options = {}) {
    ...
    this.options = Object.assign({}, defaultOptions, options);  // assigning or merging the value of {} and defaultoptions and options in one objects
  }
